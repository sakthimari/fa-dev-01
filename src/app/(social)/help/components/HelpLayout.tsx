              ...
              <figure className="m-0 d-none d-md-block">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                  ...
                  <g id="freepik--speech-bubbles-2--inject-2">
                    <path d="M393.55,253.45l4.31-7.34a27.1,27.1,0,1,1,4.72,8.49h0Z" style={{ fill: '#fff' }} />
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <rect x="420.08" y="246.74" width="4.13" height="3.86" style={{ fill: '#263238' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <rect x="426.1" y="318.89" width="3.61" height="3.37" style={{ fill: '#263238' }} />
                    <path d="M401.1,310a4.79,4.79,0,1,1-4.78-4.78A4.78,4.78,0,0,1,401.1,310Z" style={{ fill: '#fff' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <rect x="380.93" y="188.97" width="3.72" height="3.47" style={{ fill: '#263238' }} />
                    <path d="M367.55,208.1a4.93,4.93,0,1,1-4.93-4.94A4.93,4.93,0,0,1,367.55,208.1Z" style={{ fill: '#fff' }} />
                    <path
                  ...
                  <g id="freepik--speech-bubbles-1--inject-2">
                    <path
                      ...
                      style={{ fill: '#fff' }}
                    />
                    <path d="M176,151.89c0,.15-16.56.26-37,.26s-37-.11-37-.26,16.56-.26,37-.26S176,151.75,176,151.89Z" style={{ fill: '#263238' }} />
                    <path d="M176,159.92c0,.14-16.56.26-37,.26s-37-.12-37-.26,16.56-.26,37-.26S176,159.77,176,159.92Z" style={{ fill: '#263238' }} />
                    <path d="M176,167.94c0,.15-16.56.26-37,.26s-37-.11-37-.26,16.56-.26,37-.26S176,167.8,176,167.94Z" style={{ fill: '#263238' }} />
                    <path d="M176,176c0,.14-16.56.26-37,.26s-37-.12-37-.26,16.56-.26,37-.26S176,175.83,176,176Z" style={{ fill: '#263238' }} />
                    <path d="M176,184c0,.15-16.56.27-37,.27s-37-.12-37-.27,16.56-.26,37-.26S176,183.85,176,184Z" style={{ fill: '#263238' }} />
                    <path
                      ...
                      style={{ fill: '#fff' }}
                    />
                    <path d="M226,88.75c0,.14-16.56.26-37,.26s-37-.12-37-.26,16.56-.26,37-.26S226,88.61,226,88.75Z" style={{ fill: '#263238' }} />
                    <path d="M226,96.77c0,.15-16.56.26-37,.26s-37-.11-37-.26,16.56-.26,37-.26S226,96.63,226,96.77Z" style={{ fill: '#263238' }} />
                    <path d="M226,104.8c0,.14-16.56.26-37,.26s-37-.12-37-.26,16.56-.26,37-.26S226,104.66,226,104.8Z" style={{ fill: '#263238' }} />
                  </g>
                  <g id="freepik--character-2--inject-2">
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M343.26,314.05A47.18,47.18,0,0,1,319,305.6s5.28,13.27,23.93,12.91Z" style={{ fill: '#ff9a6c' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#ff9a6c' }}
                    />
                    <path d="M303.88,252.71c0-.63-.23.59,0,0Z" style={{ fill: '#455a64' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#e0e0e0' }}
                    />
                    <path d="M330.68,241.87s10,2.75,13.35,1.7a10,10,0,0,0,5.45-4.08S341.74,236.07,330.68,241.87Z" style={{ fill: '#263238' }} />
                    <path
                    ...
                    <path
                      ...
                      className="fill-primary"
                    />
                    <path d="M362.67,369.59H298.6c-5.6,32.76-19.24,45.33-43.28,64.3l-4,21.77h102l5.92-34.21-.35-12.59Z" style={{ fill: '#455a64' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M351.3,373.29a2.15,2.15,0,1,0,2.15-2.16A2.15,2.15,0,0,0,351.3,373.29Z" style={{ fill: '#e0e0e0' }} />
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <circle cx="306.38" cy="372.57" r="2.15" style={{ fill: '#e0e0e0' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M420.36,418.15a4.06,4.06,0,1,0,4.05-4A4.05,4.05,0,0,0,420.36,418.15Z" style={{ fill: '#fff' }} />
                    <path
                  ...
                  <g id="freepik--character-1--inject-2">
                    ...
                    <path
                      ...
                      style={{ fill: '#ae7461' }}
                    />
                    <path d="M236.65,257.2a44.77,44.77,0,0,1-19.17-16.42s-1.76,13.92,15.74,20Z" style={{ fill: '#6f4439' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#455a64' }}
                    />
                    <path d="M26,395.05s-5.16,13.76-7,17.46S19,456,19,456h117.7l1.66-35L81.69,386.83Z" style={{ fill: '#263238' }} />
                    <path d="M276.11,339.33l46.33,8.74s-.88,20-.29,19.54-64.94-.61-64.94-.61Z" style={{ fill: '#ae7461' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <polygon points="127.29 365.68 148.63 455.54 169.98 455.54 164.01 363.4 127.29 365.68" style={{ fill: '#ae7461' }} />
                    <path d="M168.08,442.83l21.28,3.72,19.15,5.79c1.78.61,2.91,1.63,2.2,3.86h0l-62.08-.66V444.75Z" style={{ fill: '#ae7461' }} />
                    <path
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                  <g id="freepik--Plant--inject-2">
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <polygon points="40.45 401.71 42.73 433.04 82.98 433.04 85.27 401.71 40.45 401.71" style={{ fill: '#263238' }} />
                    <rect x="36.56" y="389.36" width="53.51" height="12.35" style={{ fill: '#263238' }} />
                    <polygon points="36.56 431.84 36.56 435.26 39.07 435.26 89.19 435.26 89.19 431.84 36.56 431.84" style={{ fill: '#455a64' }} />
                    <polygon points="41.54 441.29 39.07 435.26 87.27 435.26 84.39 441.29 41.54 441.29" style={{ fill: '#455a64' }} />
                    <path
                  ...
                  <g id="freepik--Character--inject-2">
                    ...
                    <path
                      ...
                      className="fill-primary"
                    />
                    <path d="M202.21,432.3c-.27,0-1.6.82-.49,2.93s9.25,9.08,11.64,6.65-1.26-5.39-1.26-5.39Z" style={{ fill: '#ffbe9d' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M396.91,310.69a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M386.48,285.27a1.28,1.28,0,0,0-1.94-.77l-.06.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M362.55,305.74a1.28,1.28,0,0,0-1.94-.77l-.06,0a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M336.68,295.46a1.27,1.27,0,0,0-1.93-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M332.11,285.33a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M334.1,273.63a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M319.77,289.73a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M353,294.37a1.27,1.27,0,0,0-1.93-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M324.86,315.24a1.28,1.28,0,0,0-1.94-.77l-.07,0a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M299.14,375.26a1.28,1.28,0,0,0-1.94-.77l-.06.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M308.32,340.64a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M376,279.86a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M408.24,348.78a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M420.81,289.47a1.27,1.27,0,0,0-1.93-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M415.88,328.31a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M387.67,356.36a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M388.86,333a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M405.87,289.67a1.27,1.27,0,0,0-1.93-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M383,267.05a1.27,1.27,0,0,0-1.93-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M382.13,303.52a1.27,1.27,0,0,0-1.94-.77l-.06.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M352.89,414.77A1.27,1.27,0,0,0,351,414l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M319.34,396.47a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M292.21,405.44a1.28,1.28,0,0,0-1.94-.77l-.06.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M289.31,420.89a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M314.74,426.06a1.28,1.28,0,0,0-1.94-.77l-.06.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M306.24,391.46a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M337.44,400.26a1.27,1.27,0,0,0-1.94-.77l-.06.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M411.61,391.41a1.26,1.26,0,0,0-1.93-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M365.72,435.38a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M385.29,410.9a1.27,1.27,0,0,0-1.93-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M396.92,430.81A1.28,1.28,0,0,0,395,430l-.06.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M364.57,326.55a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M390.9,377.38a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M382.36,396.63a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M410.43,412.09a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M333.62,434.42a1.27,1.27,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M269.62,428.57a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M326,418.06a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M272,406.63a1.27,1.27,0,0,0-1.94-.77l-.06.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M362.2,370.33a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M343.32,315.24a1.28,1.28,0,0,0-1.94-.77l-.07,0a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M338.6,363a1.28,1.28,0,0,0-1.94-.77l-.06.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M330.92,347.43a1.28,1.28,0,0,0-1.94-.77l-.06,0a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M364.89,396.41a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.22,1.22,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M340.94,386.8A1.27,1.27,0,0,0,339,386l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M351.19,334.05a1.27,1.27,0,0,0-1.93-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M314.74,371.4a1.28,1.28,0,0,0-1.94-.77l-.06.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M371,354.26a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path d="M423.19,309.5a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M402,275.61a1.28,1.28,0,0,0-1.94-.77l-.07.06a1.21,1.21,0,1,0,2,.71Z" style={{ fill: '#fff' }} />
                    <path d="M360.94,279.86a1.28,1.28,0,0,0-1.94-.77l-.07.05a1.21,1.21,0,1,0,2,.72Z" style={{ fill: '#fff' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M336.27,254.43a57.47,57.47,0,0,0,30.24-8.06s-7.64,15.7-30.24,13.59Z" style={{ fill: '#eb996e' }} />
                    <path
                    ...
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M383.81,204c.33-.16,12.09-5.36,12.23,8.16s-13.47,10.87-13.5,10.48S383.81,204,383.81,204Z" style={{ fill: '#ffbe9d' }} />
                    <path
                  ...
                  <g id="freepik--speech-bubble--inject-2">
                    <path d="M285.4,172.73,275,154.36a49.21,49.21,0,1,0-11.79,13.12l0,0Z" style={{ fill: '#fff' }} />
                    <path d="M222.47,128.63a4,4,0,1,1-4-4A4,4,0,0,1,222.47,128.63Z" style={{ fill: '#263238' }} />
                    <path d="M238.43,128.63a4,4,0,1,1-4-4A4,4,0,0,1,238.43,128.63Z" style={{ fill: '#263238' }} />
                    <path d="M254.36,126.63a4,4,0,1,1-5.45-1.46A4,4,0,0,1,254.36,126.63Z" style={{ fill: '#263238' }} />
                  </g>
                  ...
                  <g id="freepik--Device--inject-2">
                    <path d="M353.55,442.39a26.84,26.84,0,0,1,21.39-12.08c14.61-.5,21.91,12.08,21.91,12.08Z" style={{ fill: '#455a64' }} />
                    <path
                      ...
                      style={{ fill: '#263238' }}
                    />
                    <path d="M344.51,441.86v-.1a5.6,5.6,0,0,0-5.61-5.51H214.56a5.61,5.61,0,0,0-5.61,5.61H344.51Z" style={{ fill: '#455a64' }} />
                    <path d="M106.47,224c0,2.62,2,158.78,2,158.78l116,27.91H234l-6.1-218h-8.72Z" style={{ fill: '#263238' }} />
                    <path d="M131,376.29,95.05,442.17h32.86c-5.88-.58,52,0,52,0l-52-13.79,16.27-36.95-1.39-15.14Z" style={{ fill: '#263238' }} />
                    <polygon points="131.8 388.45 127.91 265.65 163.23 262.27 167.58 393.38 154.97 394.02 131.8 388.45" style={{ fill: '#263238' }} />
                    <path
